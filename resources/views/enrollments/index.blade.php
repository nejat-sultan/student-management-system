                            ...
                            <table class="table">
                                ...
                                @foreach($enrollments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/enrollment/' . $item->id) }}" title="View Enrollments"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
