                            ...
                            <table class="table">
                                ...
                                @foreach($payments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/payment/' . $item->id) }}" title="View Payments"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/payment/' . $item->id . '/edit') }}" title="Edit Payments"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
